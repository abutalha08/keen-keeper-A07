            ...
            <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1">
                    ...
                    <div className="space-y-3 pt-4">
                        ...
                        <button className="w-full font-semibold bg-white shadow rounded-md py-3 text-sm hover:bg-gray-100 flex items-center justify-center gap-2">
                        ...
                        <button className="w-full font-semibold bg-white shadow rounded-md py-3 text-sm text-red-500 hover:bg-red-50 flex items-center justify-center gap-2">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-xl shadow p-5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            ...
                            <button className="bg-[#f3f4f6] font-semibold rounded-lg p-4 flex flex-col items-center gap-2 hover:bg-gray-100">
                                <FaPhoneAlt />
